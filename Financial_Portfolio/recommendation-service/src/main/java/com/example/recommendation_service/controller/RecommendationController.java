...
public class RecommendationController {
    ...
    public ResponseEntity<List<SymbolRecommendation>> balanceStocks(@RequestBody List<Stock> stocks,
        ...
        List<SymbolRecommendation> symbolRecommendation = recommendationService.balanceStocks(investorId, portfolioId, stocks, investedSum, tradingFee, fixedFee, minTransaction);
        System.out.println("CONTROLLER");
        for(SymbolRecommendation sr : symbolRecommendation) {
            System.out.println(sr.getSymbol() + " " + sr.getRecommendation());
        }
        return ResponseEntity.ok(symbolRecommendation);
    }
}
